package net.newt.prehistoricascension.worldgen.tree.custom;
...
public class AncientGinkgoTrunkPlacer extends TrunkPlacer {
    public static final Codec<AncientGinkgoTrunkPlacer> CODEC = RecordCodecBuilder.create((p_70161_) -> {
        return trunkPlacerParts(p_70161_).apply(p_70161_, AncientGinkgoTrunkPlacer::new);
    });
    public AncientGinkgoTrunkPlacer(int p_70148_, int p_70149_, int p_70150_) {
        super(p_70148_, p_70149_, p_70150_);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.ANCIENT_GINKGO_TRUNK_PLACER.get();
    }
