package net.newt.prehistoricascension.entity.custom;
...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public Item getDropItem() {
        switch (getModVariant()) {
            case GINKGO -> {
                return ModItems.GINKGO_CHEST_BOAT.get();
            }
        }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.GINKGO.ordinal());
    }
